                  ...
                  {suppliers.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td style={tdStyle}>
                          {item.last_upload_at
                            ? new Date(item.last_upload_at).toLocaleString()
                            : "—"}
                        </td>
                        <td style={tdStyle}>
                          <button
...
<div style={{ display: "grid", gap: 14 }}>
              ...
              <Field label="Использовать глобальные курсы">
                <input
                  ...
                  onChange={(e) =>
                    updateField("use_global_rates", e.target.checked)
                  }
                />
              </Field>
              ...
              <Field label="USD → RUB (локальный)">
                <input
                  ...
                  onChange={(e) =>
                    updateField("usd_to_rub_rate", e.target.value)
                  }
              ...
              <Field label="Скидка RUB (rub_discount_pct)">
                <input
                  ...
                  onChange={(e) =>
                    updateField("rub_discount_pct", e.target.value)
                  }
              ...
              <Field label="Скидка USD (usd_discount_pct)">
                <input
                  ...
                  onChange={(e) =>
                    updateField("usd_discount_pct", e.target.value)
                  }
                  placeholder="Например: 0.05"
                  style={inputStyle}
                />
              ...
              <Field label="Последняя загрузка">
                <div style={{ fontSize: 14, color: "#444" }}>
                  {selectedSupplier.last_upload_at
                    ? new Date(selectedSupplier.last_upload_at).toLocaleString()
                    : "—"}
                </div>
              </Field>
            </div>
