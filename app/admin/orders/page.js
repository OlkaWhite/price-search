...
export default function AdminOrdersPage() {
  ...
  async function saveOrderUpdates() {
    ...
    try {
      ...
      const normalizedManagerComment = selectedOrder.manager_comment || "";
      const normalizedInvoiceUrl = selectedOrder.invoice_url?.trim() || null;
      const normalizedProcessedAt =
        normalizedStatus === "processed"
          ? selectedOrder.processed_at || new Date().toISOString()
          : null;
      ...
      const payload = {
        ...
        processed_at: normalizedProcessedAt
      };
  ...
  async function handleDeleteOrder(orderId) {
    ...
    try {
      ...
      setErrorText("Ошибка при удалении: " + (error?.message || "неизвестная ошибка"));
    } finally {
      setSaving(false);
    }
  }
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <button onClick={addOrderItem} style={smallButtonStyle} disabled={saving}>
                    Добавить позицию
                  </button>
                </div>
