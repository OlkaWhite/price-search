          ...
          {loading ? (
            ...
            <div style={{ overflowX: "auto" }}>
              ...
              >
                <thead>
                  <tr>
                    {["ID", "Дата", "Клиент", "Статус", "Счёт", "Позиций", "Сумма", ""].map((h) => (
                      <th
                        key={h}
                        style={{
                          textAlign: "left",
...
0
                    ...
                    return (
                      <tr
                        key={order.id}
                        style={{ background: isActive ? "#f7f7f7" : "#fff" }}
                      >
                        ...
                        <td style={tdStyle}>{order.invoice_requested ? "Да" : "Нет"}</td>
        ...
        {selectedOrder && (
          ...
          >
            ...
            <div style={{ display: "grid", gap: 12 }}>
              ...
              <InfoRow label="Запрос счёта" value={selectedOrder.invoice_requested ? "Да" : "Нет"} />
              <InfoRow
                label="Сумма заказа"
            ...
            <div style={{ marginTop: 18 }}>
              ...
              <select
                ...
                onChange={(e) =>
                  setSelectedOrder((prev) => ({ ...prev, status: e.
target.value }))
                }
                style={{
                  width: "100%",
